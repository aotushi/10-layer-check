...
Lighthouse performance score 32; 4 metric(s) are poor.

Subdomain/reachability matrix: Found 1 subdomain hint(s) that may indicate exposed admin, staging, or tooling surfaces. Browser runtime observed 2 failed resource(s).
...
Public SPA route metadata: Extracted 30 route-like string candidate(s) and 18 component/page-like symbol candidate(s) from bounded public asset previews.
...
| community | community.poixe.com | / | 200 | Poixe Community |
...
| product | docs.poixe.com | /cn/docs/models-pricing/provider-routing.md | 200 | 指定模型厂商（路由） |

SPA route candidate table:
| Candidate | Source asset | Confidence |
| --- | --- | --- |
| /billing | index-CyTc29mP.js | low |
| /dashboard | index-CyTc29mP.js | medium |
| /log | index-CyTc29mP.js | low |
| /login | index-CyTc29mP.js | medium |
| /model | index-CyTc29mP.js | medium |
| /pricing | index-CyTc29mP.js | medium |
...
Bounded public app header metadata: Observed public app header metadata signal(s) on 6 bounded check(s): community.poixe.com Discourse route list/latest; community.poixe.com x-runtime 0.262622; community.poixe.com x-runtime 0.289041; community.poixe.com x-runtime 0.354501; docs.poixe.com Mintlify client 0.0.2952; docs.poixe.com Mint proxy 1.0.0-prod; docs.poixe.com Vercel cache MISS; docs.poixe.com Next/RSC vary header.

Extracted 1 scripts, 1 stylesheets, and 0 images from static HTML.

Browser runtime observed 2 third-party scripts and 12 third-party resources.

No third-party script was found in static HTML. Observed public app header metadata signal(s) on 6 bounded check(s): community.poixe.com Discourse route list/latest; community.poixe.com x-runtime 0.262622; community.poixe.com x-runtime 0.289041; community.poixe.com x-runtime 0.354501; docs.poixe.com Mintlify client 0.0.2952; docs.poixe.com Mint proxy 1.0.0-prod; docs.poixe.com Vercel cache MISS; docs.poix... Observed public CMS/forum metadata signal(s) on 8 bounded check(s). Found 1 deterministic frontend technology candidate(s).

Public SPA asset metadata: Collected bounded SPA asset metadata: React (frontend_framework, confirmed); Vite-like asset pipeline (build_tool, confirmed); React Router-like client routing (router, confirmed); CSR candidate (rendering_mode, likely); Code splitting / lazy chunk hints (code_splitting, likely); Route-like strings in public bundle preview (router, possible).

Found 2 application fingerprint candidate(s): Cloudflare, React.

Bounded public app header metadata: Observed public app header metadata signal(s) on 6 bounded check(s): community.poixe.com Discourse route list/latest; community.poixe.com x-runtime 0.262622; community.poixe.com x-runtime 0.289041; community.poixe.com x-runtime 0.354501; docs.poixe.com Mintlify client 0.0.2952; docs.po...
...
| --- | --- | --- | --- | --- |
| script | entry_bundle | /assets/index-CyTc29mP.js | 200 | vite_map_deps, react_symbol, react_dom |
...
Evidence: [E012] [E013] [E016] [E025] [E026] [E040] [E041] [M001] [M002] [M003]
...
Browser runtime observed 0.52 MiB of known transfer size with 2 unknown resource size(s).

Browser runtime observed 22 resources.

Browser runtime observed 6 API-like request(s), including 0 third-party request(s).

Browser runtime loaded the page without common access barrier signals. Browser runtime observed 2 failed resource(s).
...
Bounded public API check: Checked 2 bounded public API endpoint candidate(s); 0 exposed error/request-id signal(s). Bounded public checks include `/health` and `/v1/models`.

No obvious API or server error surface was detected in the main response.

Found 2 protocol or platform clue(s) from response headers.

API endpoint table:
| Host | Method | Path | Status | Signals |
| --- | --- | --- | --- | --- |
| api.poixe.com | GET | /health | 200 | cors_allow_origin:https://site-10-layer-check.invalid, cors_allow_credentials... |
| api.poixe.com | GET | /v1/models | 200 | cors_allow_origin:https://site-10-layer-check.invalid, cors_allow_credentials... |

CORS observation table:
| Host | Method | Path | Status | Signals |
| --- | --- | --- | --- | --- |
| poixe.com | GET | / | 200 |  |
| api.poixe.com | GET | / | 200 | cors_allow_origin:https://site-10-layer-check.invalid, cors_allow_credentials... |
| api.poixe.com | GET | /health | 200 | cors_allow_origin:https://site-10-layer-check.invalid, cors_allow_credentials... |
...
Found 2 application fingerprint candidate(s): Cloudflare, React. Subdomain/reachability matrix: Found 1 subdomain hint(s) that may indicate exposed admin, staging, or tooling surfaces.
...
| --- | --- | --- | --- |
| poixe.com | root | 200 |  |
| api.poixe.com | api | 200 |  |
| blog.poixe.com | blog | 200 |  |
| community.poixe.com | community | 200 |  |
| docs.poixe.com | docs | 308 |  |
| status.poixe.com | status | 200 |  |
...
| product | product | /cn/docs/get-started/about.md | 关于我们 |
| article | product | /1041/ | Poixe AI 如何帮助客户降低 API 使用成本 &#8211; Poixe Blog |
| unknown | unknown | / | Poixe AI |

Evidence: [E044] [E045] [E046] [E047] [E048] [M025] [M026] [M027] [M028]

Boundaries: Registration and historical evidence do not prove current operator or legal ownership.

## Security Posture

Collected organization-facing DNS, homepage, registration, or archive evidence. Public business/product content: Collected public business/product text snippets from 5 bounded page(s): homepage / unknown / Poixe AI; blog / news / Poixe Blog &#8211; The most powerful platform for building AI products.; community / community / Poixe Community; docs / technical_documentation / Poixe AI - Poixe Docs; status / commercial / poixe status. Public product/business detail: Collected public product/business detail snippets from 8 bounded page(s): product / docs / product / 供应商入驻; product / docs / product / 收益提现; product / docs / product / 指定模型厂商（路由）; product / docs / product / 关于我们; article / blog / product / Poixe AI 如何帮助客户降低 API 使用成本 &#8211; Poixe Blog. Collected RDAP / WHOIS-lite registration evidence. Collected Wayback historical archive evidence. Observed Set-Cookie header(s) on 1 bounded public check(s).
...
| --- | --- | --- | --- | --- |
| poixe.com | GET | / | 200 |  |
| api.poixe.com | GET | / | 200 |  |
| blog.poixe.com | GET | / | 200 |  |
| blog.poixe.com | HEAD | /wp-login.php | 200 | set_cookie_observed, public_route_presence_observed |
