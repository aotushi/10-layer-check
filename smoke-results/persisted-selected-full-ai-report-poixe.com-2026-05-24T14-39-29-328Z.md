...
Performance score 31; 5 metric(s) are poor.
...
Bounded public app header metadata: Observed public app header metadata signal(s) on 6 bounded check(s): community.poixe.com Discourse route list/latest; community.poixe.com x-runtime 0.274054; community.poixe.com x-runtime 0.486275; community.poixe.com x-runtime 0.187359; docs.poixe.com Mintlify client 0.0.2952; docs.poixe.com Mint proxy 1.0.0-prod; docs.poixe.com Vercel cache MISS; docs.poixe.com Next/RSC vary header.
...
Live certificate expires in 55 day(s). Final response returned HTTP 200.
...
Collected organization-facing DNS, homepage, registration, or archive evidence. Mail DNS includes larksuite MX/TXT signals.
