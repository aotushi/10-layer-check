...
HTTPS is reachable, but HSTS was not found on the probed response. Evidence: https=url=https://poixe.com/, reachable=true, status_code=200; strict-transport-security=null; certspotter=none.
...
Lighthouse performance score 36; 3 metric(s) are poor. Evidence: lighthouse=5 item(s): First Contentful Paint 3965.7899999999995 poor, Largest Contentful Paint 6252.633 poor, Total Blocking Time 3711.4310000000005 poor (+2 more); lighthouse=6 item(s): unused-javascript, server-response-time, redirects (+3 more). Missing security headers: content-security-policy, strict-transport-security, permissions-policy. Evidence: x-frame-options=SAMEORIGIN; x-content-type-options=nosniff; referrer-policy=strict-origin-when-cross-origin.

Evidence: [E004] [E028] [E029] [E055] [E003] [E023] [M001] [M002] [M003]
...
Subdomain/reachability matrix: CT subdomain provider lookup failed: certspotter: Cert Spotter returned 429.; crtsh: crt.sh returned 502.. Evidence: provider_status=provider=certspotter+crtsh, status=error, certificate_count=0, error=certspotter: Cert Spotter returned 429.; crtsh: crt.sh returned 502.; provider_attempts=2 item(s); subdomains=none; https_reachability=none.
...
Found 2 application fingerprint candidate(s): Cloudflare, React. Evidence: Cloudflare=category=hosting, confidence=high, evidence=server: cloudflare; Cloudflare=category=hosting, confidence=high, evidence=cf-ray: a00ce2fd6ddf2ebd-LAX; React=category=framework, confidence=medium, evidence=html matched /id=["']root["']/i.

Bounded public app header metadata: Observed public app header metadata signal(s) on 6 bounded check(s): community.poixe.com Discourse route list/latest; community.poixe.com x-runtime 0.436687; community.poixe.com x-runtime 0.409709; community.poixe.com x-runtime 0.310490; docs.poixe.com Mintlify client 0.0.2952; docs.poixe.com Mint proxy 1.0.0-prod; docs.poixe.com Vercel cache MISS; docs.poixe.com Next/RSC vary header. Evidence: public_app_header_metadata=3 endpoint(s): blog.poixe.com /wp-json/ status 200, community.poixe.com / status 200 (+1 more); public_security_detail_limits=max_hosts=... Extracted 1 scripts, 1 stylesheets, and 0 images from static HTML. Evidence: html_bytes=2799; scripts=1; stylesheets=1; images=0. Browser runtime observed 2 third-party scripts and 10 third-party resources. Evidence: script=https://static.cloudflareinsights.com/beacon.min.js/v833ccba57c9e4d2798f2e76cebdd09a11778172276447; script=https://matomo.gptocean.com/matomo.js; ping=https://matomo.gptocean.com/matomo.php?...; image=https://s3.poixe.com/apple/avatar-2.webp. No third-party script was found in static HTML. Collected bounded SPA asset metadata: React (frontend_framework, confirmed); Vite-like asset pipeline (build_tool, confirmed); React Router-like client routing (router, confirmed); CSR candidate (rendering_mode, likely); Code splitting / lazy chunk hints (code_splitting, likely); Route-like strings in public bundle preview (router, possible). Observed public app header metadata signal(s) on 6 bounded check(s): community.poixe.com Discourse route list/latest; community.poixe.com x-runtime 0.436687; community.poixe.com x-runtime 0.409709; community.poixe.com x-runtime 0.310490; docs.poixe.com Mintlify client 0.0.2952; docs.poixe.com Mint proxy 1.0.0-prod; docs.poixe.com Vercel cache MISS; docs.poix... Observed public CMS/forum metadata sig...
...
Lighthouse performance score 36; 3 metric(s) are poor. Evidence: lighthouse=5 item(s): First Contentful Paint 3965.7899999999995 poor, Largest Contentful Paint 6252.633 poor, Total Blocking Time 3711.4310000000005 poor (+2 more); lighthouse=6 item(s): unused-javascript, server-response-time, redirects (+3 more).
...
Collected Wayback historical archive evidence. Evidence: wayback_snapshot_count_estimate=null; wayback_first_snapshot=status_code=200; wayback_last_snapshot=status_code=200. Collected public business/product text snippets from 5 bounded page(s): homepage / unknown / Poixe AI; blog / news / Poixe Blog &#8211; The most powerful platform for building AI products.; community / community / Poixe Community; docs / technical_documentation / Poixe AI - Poixe Docs; status / commercial / poixe status.
...
Browser runtime observed 0 console error(s) and 2 failed request(s). Evidence: runtime_mixed_content_candidate_count=0; runtime_failed_request_count=2; runtime_console_error_count=0; runtime_page_error_count=0. No obvious static leakage signals were found in the main HTML. Evidence: leakage_signals=none.
