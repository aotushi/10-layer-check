...
Bounded public app header metadata: Observed public app header metadata signal(s) on 6 bounded check(s): community.poixe.com Discourse route list/latest; community.poixe.com x-runtime 0.230358; community.poixe.com x-runtime 0.421483; community.poixe.com x-runtime 0.302093; docs.poixe.com Mintlify client 0.0.2952; docs.poixe.com Mint proxy 1.0.0-prod; docs.poixe.com Vercel cache MISS; docs.poixe.com Next/RSC vary header.
...
Public operations evidence: Public SPA operation evidence: Extracted 60 route-like string candidate(s) and 23 component/page-like symbol candidate(s) from bounded public asset previews.. Operation hints: vendor revenue/payout. Signals: vendor revenue/payout: /setting/payment; vendor revenue/payout: /setting/payment/update_usdt_address; vendor revenue/payout: /setting/payment/upload_alipay_qrcode; vendor revenue/payout: /setting/payment/withdraw_methods. Preserved 2 bounded public API endpoint observation(s): /health, /v1/models. Collected public business/product text snippets from 5 bounded page(s): homepage / unknown / Poixe AI; blog / news / Poixe Blog &#8211; The most powerful platform for building AI products.; community / community / Poixe Community; docs / technical_documentation / Poixe AI - Poixe Docs; status / commercial / poixe status.
...
| vendor revenue/payout | /setting/payment | SPA asset string + public payout docs | medium |
| vendor revenue/payout | /setting/payment/update_usdt_address | SPA asset string + public payout docs | medium |
| vendor revenue/payout | /setting/payment/upload_alipay_qrcode | SPA asset string + public payout docs | medium |
| vendor revenue/payout | /setting/payment/withdraw_methods | SPA asset string + public payout docs | medium |
