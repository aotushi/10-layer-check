...
Lighthouse performance score 32; 4 metric(s) are poor. Found 1 subdomain hint(s) that may indicate exposed admin, staging, or tooling surfaces.
...
Bounded public app header metadata: Observed public app header metadata signal(s) on 6 bounded check(s): community.poixe.com Discourse route list/latest; community.poixe.com x-runtime 0.503656; community.poixe.com x-runtime 0.678668; community.poixe.com x-runtime 0.346089; docs.poixe.com Mintlify client 0.0.2952; docs.poixe.com Mint proxy 1.0.0-prod; docs.poixe.com Vercel cache MISS; docs.poixe.com Next/RSC vary header.

Extracted 1 scripts, 1 stylesheets, and 0 images from static HTML.

Browser runtime observed 2 third-party scripts and 9 third-party resources.
...
| --- | --- | --- | --- | --- |
| script | entry_bundle | /assets/index-CyTc29mP.js | 200 | vite map deps, react symbol, react dom |
...
Browser runtime observed 1 failed resource(s).
...
Bounded public CORS check: Observed CORS response header signal(s) on 4 bounded public check(s). Bounded public checks include `/health` and `/v1/models`.

No CORS headers were found on the main response. Bounded public CORS check: Observed CORS response header signal(s) on 4 bounded public check(s). CORS response-header signals were observed in bounded public checks.
...
| technical_documentation | technical_documentation | /cn/docs/get-started/overview | Poixe AI - Poixe Docs |
