...
- 2026-05-25 poixe selected full-scan persisted AI report path is verified remotely for `G1.11 Operation Evidence Density Cleanup`: Worker version `72a8e5b0-d749-43a7-b26f-c5245d7f8460`, job `scan-poixe.com-f35dd3df-5061-49d1-b71e-b3dc3c3eb12d`, 57 records, Layers 1-10, canonical 10-section AI Markdown, direct Markdown/JSON parity, no stacked `Public operations evidence: Public SPA operation evidence` prefix, one compact `vendor revenue/payout` operation row, `/vendor/revenue` preserved as a low-confidence derived alias, and unsupported exact aliases `/vendor/log` plus `/model?tab=model-load` still absent from the route table. Artifacts: `smoke-results/persisted-selected-full-ai-report-poixe.com-2026-05-25T04-31-00-962Z.json` and `smoke-results/persisted-selected-full-ai-report-poixe.com-2026-05-25T04-31-00-962Z.md`.
